        ...
        try {
            switch (payload.getPayloadType()) {
                ...
                case DISCONNECT:
                    ...
                    break;
                case ROLL:
                    int diceResult = currentRoom.rollDice();
                    currentRoom.sendDiceResult(this, diceResult); // Notify all clients in the room
                    break;
                case FLIP:
                    String flipResult = currentRoom.flipCoin();
                    currentRoom.sendCoinFlipResult(this, flipResult);
                    break;
                default:
                    info("Unknown payload type: " + payload.getPayloadType());
                    break;
            }
        } catch (Exception e) {
            System.out.println("Error processing payload: " + payload);
            e.printStackTrace();
        }
    }
